...
function solve() {
  ...
  addButtonElement.addEventListener("click", (e) => {
    e.preventDefault(); // за да спрем презареждането и да можем да видим конзол лога
    ...
    priceCellElement.textContent = price.toFixed(2); //прави го стринг, но след като го закрепим повече няма да ни трябва
    ...
    infoButtonElement.addEventListener("click", (e) => {
      if (e.currentTarget.textContent == "More Info") {
        ...
        e.currentTarget.textContent = "More Info"; //target - това, което натискаме; currentTarget - това, върху което е сложен евента;
      }
    });
