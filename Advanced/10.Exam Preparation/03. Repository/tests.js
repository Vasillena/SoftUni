...
describe("Repository", () => {
  ...
  describe("Add entity", () => {
    ...
    it("Should throw if updating with invalid entity", () => {
      ...
      expect(() => repository.add(entity1)).to.throw(
        Error,
        `Property age is missing from the entity!`
      );
      expect(() => repository.add(entity2)).to.throw(
        Error,
  ...
  describe("Get Id", () => {
    ...
    it("Should throw error when no id is found", () => {
      ...
      expect(() => repository.getId(-3.14)).to.throw(
        Error,
        "Entity with id: -3.14 does not exist!"
      );
    });
  });
