...
async function loadPost(postId) {
  try {
    ...
    const themeTitileDivElement = createElements(
      "div",
      "",
      themContentDivElement,
      {
        class: "theme-title",
      }
    );
    ...
    const asnwerCommentDivElement = createElements(
      "div",
      "",
      themContentDivElement,
      {
